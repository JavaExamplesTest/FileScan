...
public class FileInformationServiceImpl implements FileInformationService{
    ...
    public List<String> readVehicleRegNo()
    {
        ...
        //String dirLocation = properties.getProperty("file.vehicle.registration.details");
            ...
            while (cells.hasNext())
            {
                ...
                if (cell.getCellType() == XSSFCell.CELL_TYPE_STRING)
                {
                    if (!cell.getStringCellValue().equalsIgnoreCase(VEHICLE_REGISTRATION_NO)) {
                        ...
                        vehicleRegNoList.add(cell.getStringCellValue());
                        logger.info("VEHICLE REGISTRATION NO : " +cell.getStringCellValue());
                    }
